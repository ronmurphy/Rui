...
// ── New handlers (generated by Rui for layout.ui) ─────

/// Handler for GtkButton (id="btn_new") — signal "clicked"
fn on_btn_new_clicked(widget: &Button) {
    // TODO: implement handler
}

/// Handler for GtkButton (id="btn_open") — signal "clicked"
fn on_btn_open_clicked(widget: &Button) {
    // TODO: implement handler
}

/// Handler for GtkButton (id="btn_save") — signal "clicked"
fn on_btn_save_clicked(widget: &Button) {
    // TODO: implement handler
}
